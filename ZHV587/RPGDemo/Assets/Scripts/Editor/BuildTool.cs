...
public class BuildTool
{
    ...
    private static string ANDROID_APK_PATH = "Bin/TheKing.apk";
    ...
    private static void SetAPKName()
    {
        ...
        ANDROID_APK_PATH = "Bin/TheKing" + datetime + "_" + maxIndex + ".apk";
    }
    ...
    private static void SetKeyStore()
    {
        ...
        PlayerSettings.Android.keystoreName = "Terminator.keystore";
        PlayerSettings.Android.keystorePass = "qwer1234";
        PlayerSettings.Android.keyaliasName = "terminator";
