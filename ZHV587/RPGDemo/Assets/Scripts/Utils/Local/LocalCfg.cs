...
namespace Air2000
{
    public class LocalCfg
    {
        ...
        public class Handle
        {
            ...
            public Handle(LocalCfgCallback varFunc, Type varTargetType, string varFilePath)
            {
                Callback = varFunc;
        ...
        public T DeserializeObjFromFile<T>(string varFileName)
        {
            ...
            string filePath = "not implement!!!";// ResLoader.GetSavePath() + "/" + varFileName;
            byte[] bytes = null;
            try
            {
        ...
        //    if (handle == null)
        //    {
        //        CommonUtils.LogError("LocalCfg OnLoadCfgFileCallback: Error caused by null Handle instance");
        //        return;
        //    }
        //    if (varObjInfo == null)
        //    {
        //        CommonUtils.LogError("LocalCfg OnLoadCfgFileCallback: Error caused by null CacheObjInfo instance");
        //        return;
        //    }
        //    if (varObjInfo.GetObj() == null)
        //    {
        //        CommonUtils.LogError("LocalCfg OnLoadCfgFileCallback: Error caused by null CacheObjInfo.GetObj() instance");
        //        return;
        //    }
        //    TextAsset textAsset = varObjInfo.GetObj() as TextAsset;
        //    if (textAsset == null)
        //    {
        //        CommonUtils.LogError("LocalCfg OnLoadCfgFileCallback: Error caused by null TextAsset instance");
        //        return;
        //    }
        //    Stream stream = new MemoryStream(textAsset.bytes, false);
        //    if (stream == null)
        //    {
        //        CommonUtils.LogError("LocalCfg OnLoadCfgFileCallback: Error caused by null MemoryStream instance");
        //        return;
        //    }
